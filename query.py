...
#proxies = ['125.163.160.46:8089','200.73.128.86:80']
#proxies = get_proxies()
proxies = ['']
proxy_pool = cycle(proxies)

def query_single_page(query, lang, pos, retry=10, from_user=False, timeout=60):
    """
...
def query_tweets(query, limit=None, begindate=dt.date(2006, 3, 21), enddate=dt.date.today(), poolsize=3, lang=''):
